const seccionesPagina = new fullpage('#fullpage',{
	...
	// ──────────────────────────────────────────────────
		 ...
		 anchors: ['Inicio','Plantel', 'Contacto'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu.
		 navigationTooltips: ['Inicio','Plantel','Contacto'], // Tooltips que mostrara por cada boton.
...
// ──────────────────────────────────────────────────
	...
	// ──────────────────────────────────────────────────
		 ...
		 if(destination.anchor == 'Contacto'){
			  document.querySelector('.footer').querySelector('h2').style.opacity = 6;
		 }
	}
});